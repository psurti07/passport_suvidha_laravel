...
class ApplicationStatusSeeder extends Seeder
{
    ...
    {
        $statuses = [
            ['status_name' => 'In Process', 'slug' => 'in_process', 'priority_no' => 4, 'colorclass' => 'blue', 'step' => 7],

            ['status_name' => 'Documents Submitted', 'slug' => 'documents_submitted', 'priority_no' => 5, 'colorclass' => 'green', 'step' => 8],
            ['status_name' => 'Details Verification', 'slug' => 'details_verification', 'priority_no' => 6, 'colorclass' => 'yellow', 'step' => 8],
