...
class ApplicationStatusSeeder extends Seeder
{
    ...
    public function run()
    {
        $statuses = [
            ...
            ['status_name' => 'Appointment Scheduled', 'slug' => 'appointment_scheduled', 'priority_no' => 11, 'colorclass' => 'orange', 'step' => 17],

            ['status_name' => 'Appointment Rescheduled 1', 'slug' => 'appointment_rescheduled1', 'priority_no' => 12, 'colorclass' => 'orange', 'step' => 18],

            ['status_name' => 'Appointment Rescheduled 2', 'slug' => 'appointment_rescheduled2', 'priority_no' => 13, 'colorclass' => 'orange', 'step' => 19],

            ['status_name' => 'Appointment Rescheduled 3', 'slug' => 'appointment_rescheduled3', 'priority_no' => 14, 'colorclass' => 'orange', 'step' => 20],

            ['status_name' => 'POV Success', 'slug' => 'pov_success', 'priority_no' => 15, 'colorclass' => 'green', 'step' => 21],

            ['status_name' => 'POV Failed', 'slug' => 'pov_failed', 'priority_no' => 16, 'colorclass' => 'red', 'step' => 22],

            ['status_name' => 'POV Insufficient Documents', 'slug' => 'pov_insufficient_documents', 'priority_no' => 17, 'colorclass' => 'pink', 'step' => 23],

            ['status_name' => 'Not Intersted', 'slug' => 'not_intersted', 'priority_no' => 18, 'colorclass' => 'red', 'step' => 24],
        ];
