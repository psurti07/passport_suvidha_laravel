                ...
                <form id="filterForm">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-center mb-6">
                        <div class="flex items-center gap-4">
                            <h2
                                class="text-xl sm:text-2xl mb-3 md:text-2xl md:mb-6 font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                                OTPS
                            </h2>
                        </div>
                        <div class="flex flex-wrap gap-2 lg:gap-3">
                            ...
                            <div>
                                ...
                                <select id="is_verified" class="border rounded-lg px-3 py-2 text-sm sm:w-32 w-[150px]">
