        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('admin.customers.update', $customer) }}" class="space-y-6">
                ...
                <div class="flex items-center">
                    <input id="is_paid" name="is_paid" type="checkbox" value="1" {{ old('is_paid', $customer->is_paid) ? 'checked' : '' }} 
                ...
                <div x-data="{ isPaid: {{ old('is_paid', $customer->is_paid) ? 'true' : 'false' }} }" @paid-status-change.window="isPaid = $event.detail" x-show="isPaid" x-transition class="space-y-6 border-t border-gray-200 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
                            ...
                            <input id="pack_code" 
                                   ...
                                   name="pack_code" 
                                   value="{{ old('pack_code', $customer->pack_code) }}" 
                                   :required="isPaid" 
                        ...
                        <div class="space-y-1">
                            ...
                            <input id="service_code" 
                                   ...
                                   name="service_code" 
                                   value="{{ old('service_code', $customer->service_code) }}" 
                                   :required="isPaid" 
                    ...
                    <div class="space-y-1">
                        ...
                        <input id="payment_info_id" 
                               ...
                               value="{{ old('payment_info_id', $customer->payment_info_id) }}" 
                               :required="isPaid" 
