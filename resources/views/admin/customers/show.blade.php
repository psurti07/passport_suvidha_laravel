            ...
            <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                ...
                <form action="{{ route('admin.customers.update', $customer->id) }}" method="POST" class="space-y-5"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                        ...
                        <div>
                            <label for="emergency_contact_name" class="block text-sm font-medium text-gray-700 mb-1">Emergency Contact Name
                                <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label for="emergency_contact_email" class="block text-sm font-medium text-gray-700 mb-1">Emergency Contact Email <span
                                    class="text-red-500">*</span></label>
