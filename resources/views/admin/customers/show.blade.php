                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                            ...
                            @error('username') border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                                ...
                                <button type="button"
                                    ...
                                    <svg x-show="copiedField !== 'password'" class="w-5 h-5" fill="none"
                                        ...
                                        <rect x="3" y="8" width="12" height="12" rx="2" ry="2" />
                                    </svg>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input :type="showPassword ? 'text' : 'password'" id="passport_password" name="password"
                                    value="{{ old('password', $passportPassword ?? '') }}" required
