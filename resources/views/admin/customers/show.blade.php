...
@section('content')
    ...
    ========================================================== --}}
                    ...
                    focus:ring-opacity-50 transition-all duration-200 sm:text-sm
                    ...
                    @error('father_name') border-red-300 text-red-900 @enderror">
                                ...
                                <div>
                                    <label for="mother_name" class="block text-sm font-medium text-gray-700 mb-1">
                                        Mother Name <span class="text-red-500">*</span>
                                    </label>
    ...
    ========================================================== --}}
                    ...
                    hover:border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200
                    focus:ring-opacity-50 transition-all duration-200 sm:text-sm
                    @error('address') border-red-300 text-red-900 @enderror">{{ old('address', $customer->address ?? '') }}</textarea>
                    ...
                    @error('state') border-red-300 text-red-900 @enderror">
                        ...
                        hover:border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200
                        focus:ring-opacity-50 transition-all duration-200 sm:text-sm
                        @error('permanent_address') border-red-300 text-red-900 @enderror">{{ old('permanent_address', $customer->permanent_address ?? '') }}</textarea>
                                    ...
                                    <div>
                                        <label for="permanent_pin_code"
                                            class="block text-sm font-medium text-gray-700 mb-1">
                                            Permanent Pincode <span class="text-red-500">*</span>
                                        </label>
                        ...
                        @error('permanent_pin_code') border-red-300 text-red-900 @enderror">
                                    ...
                                    <div>
                                        <label for="permanent_city" class="block text-sm font-medium text-gray-700 mb-1">
                                            Permanent City <span class="text-red-500">*</span>
                                        </label>

                                        <input type="text" id="permanent_city" name="permanent_city"
                                            value="{{ old('permanent_city', $customer->permanent_city ?? '') }}" readonly
                                            class="block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm py-2 px-3
                        hover:border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200
                        focus:ring-opacity-50 transition-all duration-200 sm:text-sm
                        @error('permanent_city') border-red-300 text-red-900 @enderror">
                                    ...
                                    <div>
                                        <label for="permanent_state" class="block text-sm font-medium text-gray-700 mb-1">
                                            Permanent State <span class="text-red-500">*</span>
                                        </label>
                    ...
                    @error('email') border-red-300 text-red-900 @enderror">
                                ...
                                {{-- Police Station --}}
                                <div>
                                    <label for="police_station_name" class="block text-sm font-medium text-gray-700 mb-1">
                                        Nearest Police Station Name <span class="text-red-500">*</span>
                                    </label>
                    ...
                    @error('emergency_contact_name') border-red-300 text-red-900 @enderror">
                                ...
                                <div>
                                    <label for="emergency_contact_mobile"
                                        class="block text-sm font-medium text-gray-700 mb-1">
                                        Emergency Contact Mobile <span class="text-red-500">*</span>
                                    </label>
                    ...
                    @error('emergency_contact_mobile') border-red-300 text-red-900 @enderror">
                                ...
                                <div>
                                    <label for="emergency_contact_email"
                                        class="block text-sm font-medium text-gray-700 mb-1">
                                        Emergency Contact Email <span class="text-red-500">*</span>
                                    </label>
