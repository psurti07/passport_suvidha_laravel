        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="p-8 pt-0">
                <form method="POST" action="{{ route('admin.customers.store') }}" class="space-y-6" novalidate>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                <input type="date" id="payment_date" name="payment_date"
                                    value="{{ old('payment_date', date('Y-m-d')) }}" :required="isPaid"
                                    ...
                                    class="peer p-2 pl-3 mt-1 block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm 
                                            ...
                                            @error('payment_date') border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                            </div>
                            @error('payment_date')
                    ...
                    <<<<<<< HEAD <div class="border-b border-gray-200">
                        <div style="opacity: 1; transform: none;">
                            <div class="md:text-xl font-semibold tracking-tight text-xl flex items-center gap-2 mb-4">
                            ...
                            <div class="border-b border-gray-200">
                                <div style="opacity: 1; transform: none;">
                                    <div
                                        class="md:text-xl font-semibold tracking-tight text-xl flex items-center gap-2 mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                ...
                                <div>
                                    ...
                                    <div class="relative group">
                                        <input type="text" id="mother_name" name="mother_name"
                                            value="{{ old('mother_name') }}" required placeholder="Enter father name"
                                            class="peer p-2 pl-3 mt-1 block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm 
                                        hover:border-gray-300 focus:border-gray-500 focus:ring focus:ring-gray-200 focus:ring-opacity-50 
                                        transition-all duration-200 placeholder-gray-400
                                    ...
                                    <div>
                                        ...
                                        <div class="relative group">
                                            <input type="text" id="emergency_contact_name" name="emergency_contact_name"
                                                ...
                                                placeholder="Enter emergency contact name" class="peer p-2 pl-3 mt-1 block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm 
=======
                        <div class=" grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                <label for="emergency_contact_name"
...
>>>>>>> main
                                        ...
                                        @error('emergency_contact_name') border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                                            ...
                                            <<<<<<< HEAD @error('emergency_contact_name') <p
                                        ...
                                        <div>
                                            ...
                                            <div class="relative group">
                                                <input type="tel" id="emergency_contact_mobile"
                                                    ...
                                                    placeholder="Enter emergency contact mobile" maxlength="10"
                                                    inputmode="numeric"
                                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="peer p-2 pl-3 mt-1 block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm hover:border-gray-300 focus:border-gray-500 focus:ring focus:ring-gray-200 focus:ring-opacity-50 transition-all duration-200 placeholder-gray-400
=======
                            <div>
                                <label for=" emergency_contact_mobile"
                                                    class="block text-sm font-semibold text-gray-900">
...
>>>>>>> main
                                    @error('emergency_contact_mobile') border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                                        ...
                                        <<<<<<< HEAD <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <div class="relative group">
                                                    <input type="emergency_contact_email" id="emergency_contact_email"
                                                        ...
                                                        placeholder="Enter emergency contact email" class="peer p-2 pl-3 mt-1 block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm 
=======
                        <div class=" grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    <div>
                                                        <label for="emergency_contact_email"
                                                        ...
                                                        <div class="relative group">
                                                            <input type="emergency_contact_email"
                                        ...
                                        @error('emergency_contact_email') border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-1 gap-12">
                                                <div>
                                                    ...
                                                    <div class="relative group">
                                                        <textarea id="address" name="address" :required="isPaid"
                                                            placeholder="Enter address" rows="3" class="peer p-2 pl-3 mt-1 block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm 
=======
                        <div class=" border-b border-gray-200">
                            <div style="opacity: 1; transform: none;">
                                <div class="md:text-xl font-semibold tracking-tight text-xl flex items-center gap-2 mb-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="relative group">
                                                            <input type="text" id="pin_code" name="pin_code"
                                                                inputmode="numeric" value="{{ old('pin_code') }}"
                                                                :required="isPaid" placeholder="Enter pincode"
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="relative group">
                                                                <input type="text" id="city" name="city"
                                                                    value="{{ old('city') }}" :required="isPaid"
                                                                    placeholder="Enter city" readonly class="peer p-2 pl-3 mt-1 block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm 
=======
                            <div>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div class="relative group">
                                                                                    ...
                                                                                    Below 10th
                                                                                        ...
                                                                                        <option
                                                                                            value="Between 8th And 9th Standard"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div id="organisation-wrapper"
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        class="block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm py-2 px-3 hover:border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-all duration-200 sm:text-sm @error('organisation_name') border-red-300 @enderror">
