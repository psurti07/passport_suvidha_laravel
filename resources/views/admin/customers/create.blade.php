        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="p-8 p-0">
                <form method="POST" action="{{ route('admin.customers.store') }}" class="space-y-6" novalidate>
                    ...
                    <div x-data="{ isPaid: {{ old('is_paid') ? 'true' : 'false' }} }"
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    <input type="text" id="pin_code" name="pin_code" value="{{ old('pin_code') }}"
                                        :required="isPaid" placeholder="Enter pincode" maxlength="6" minlength="6"
                                        oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                        class="peer p-2 pl-3 mt-1 block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm 
                                            hover:border-gray-300 focus:border-gray-500 focus:ring focus:ring-gray-200 focus:ring-opacity-50 
                                            transition-all duration-200 placeholder-gray-400
                                ...
                                <div>
                                    ...
                                    <div class="relative group">
                                        <input type="text" id="card_number" name="card_number"
                                            ...
                                            placeholder="Enter card number" class="peer p-2 pl-3 mt-1 block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm 
                                                hover:border-gray-300 focus:border-gray-500 focus:ring focus:ring-gray-200 focus:ring-opacity-50 
                                                transition-all duration-200 placeholder-gray-400">
                                    </div>
                                </div>
