        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                <div class="flex flex-col md:flex-row justify-between items-center mb-6">
                    <h2
                        class="text-xl mb-3 sm:text-2xl md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                        View Predefined Message
                    </h2>
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('admin.predefined-messages.edit', ['predefined_message' => $preDefinedMessage->id]) }}"
                ...
                <div class="mt-8 border border-gray-100 rounded-xl overflow-hidden">
                    ...
                    <div class="bg-white p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="ml-7">
                                <p class="text-gray-800 bg-gray-50 p-3 rounded-lg border border-gray-100">
                                    {{ $preDefinedMessage->status->status_name ?? '-' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="ml-7">
                                <p class="text-gray-800 bg-gray-50 p-3 rounded-lg border border-gray-100">
                                    {{ $preDefinedMessage->message_name }}</p>
                            </div>
                        </div>
                ...
                <div class="mt-6 flex justify-end">
                    <form
                        action="{{ route('admin.predefined-messages.destroy', ['predefined_message' => $preDefinedMessage->id]) }}"
