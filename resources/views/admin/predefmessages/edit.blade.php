...
@section('title', 'Edit Predefined Message')
...
<div class="mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100">
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <form action="{{ route('admin.predefined-messages.update', ['predefined_message' => $preDefinedMessage->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    {{-- Message Name --}}
                    <div>
                        ...
                        <input type="text" name="message_name" id="message_name" required value="{{ old('message_name', $preDefinedMessage->message_name) }}"
