            ...
            <div class="p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="flex flex-col 2xl:flex-row justify-between items-center mb-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <div>
                                ...
                                <select id="is_mandatory" class="border rounded-lg px-3 py-2 text-sm sm:w-32 w-[150px]">
                ...
                <div class="mt-4 overflow-x-auto">
                    <div class="whitespace-nowrap text-sm text-gray-700">
                        ...
                        <table id="document-types-table" class="min-w-full divide-y divide-gray-200 pt-5">
    ...
    <script>
        $(function() {
            ...
            let table = $('#document-types-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.document-types.data') }}",
                    data: function(d) {
                        d.from_date = $('#from_date').val();
                        d.to_date = $('#to_date').val();
                        d.is_mandatory = $('#is_mandatory').val();
                    }
                },
