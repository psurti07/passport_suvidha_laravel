        ...
        <div class="p-4 sm:p-6 lg:p-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin.document-types.edit', $documentType) }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg text-sm font-medium hover:from-blue-700 hover:to-blue-900 transition-all duration-200 shadow-md hover:shadow-lg">
            ...
            <div class="mt-8 border border-gray-100 rounded-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 border-b border-gray-100 flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-xs text-gray-500">Created: {{ $documentType->created_at->format('d/m/Y H:i:s') }}</p>
                        <p class="text-xs text-gray-500">Last Updated: {{ $documentType->updated_at->format('d/m/Y H:i:s') }}</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="ml-7">
                            <p class="text-gray-800 bg-gray-50 p-3 rounded-lg border border-gray-100">{{ $documentType->name }}</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="ml-7">
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100 whitespace-pre-wrap text-gray-800">{{ $documentType->description }}</div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="ml-7">
                            <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                                <span class="px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full {{ $documentType->is_mandatory ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
            ...
            <div class="mt-6 flex justify-end">
                <form action="{{ route('admin.document-types.destroy', $documentType) }}" method="POST" class="inline delete-document-type-form">
                    @csrf
                    @method('DELETE')
