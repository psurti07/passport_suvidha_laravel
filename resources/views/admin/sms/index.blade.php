        ...
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="mt-4 overflow-x-auto">
                <div class="whitespace-nowrap text-sm text-gray-700">
                    ...
                    <table id="sms-messages-table" class="min-w-full divide-y divide-gray-200">
                        ...
                        <thead class="bg-blue-50">
                            ...
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">SMS Name
                                </th>
