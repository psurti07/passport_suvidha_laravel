        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="flex flex-col lg:flex-row md:flex-row justify-between items-center mb-6">
                    ...
                    <h2
                        class="text-xl sm:text-2xl md:text-2xl md:mb-3 mb-3 sm:pb-3px font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                        TODAY'S LEADS
                    </h2>
                ...
                <div class="mt-4 overflow-x-auto">
                    <div class="whitespace-nowrap text-sm text-gray-700">
                        ...
                        <table id="today-table" class="min-w-full divide-y divide-gray-200">
