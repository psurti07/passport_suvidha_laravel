...
<div class="mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100">
        <div class="p-4 sm:p-6 lg:p-8">
            <form id="filterForm" action="{{ route('admin.leads.normal') }}" method="POST">
                @csrf
                ...
                <div class="flex flex-col lg:flex-row justify-between items-center mt-6 gap-4">
                    <div class="flex flex-wrap items-center gap-2 space-x-2">
                        ...
                        <a href="{{ route('admin.leads.normal', ['type' => 'excel'] + request()->all()) }}"
                            class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md hover:bg-gray-100 transition-colors duration-150">
                            Excel
                        </a>
                        <a href="{{ route('admin.leads.normal', ['type' => 'excel'] + request()->all()) }}"
                    ...
                    <div class="shadow-sm ring-1 ring-black ring-opacity-5">
                        <table class="min-w-full divide-y divide-gray-200 relative">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr
                                    class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors duration-150 cursor-pointer">
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-10 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="mt-1 text-gray-400 text-xs">Try adjusting your search or filter to
...
function showToast(message, type = 'success') {
    ...
    switch (type) {
        ...
        case 'warning':
            ...
            iconSvg =
                `<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM10 13a1 1 0 110-2 1 1 0 010 2zm-1-4a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>`;
            break;
        default: // Info
...
function copyToClipboard() {
    ...
    // Check if the only row is the "No leads found" row (using colspan="7")
    ...
    text += rows.map(row => {
            // Skip the "No leads found" row if it exists among other rows
...
function sortLink($column, $label)
{
    ...
    return '<a href="#" onclick="
        let sortBy = document.querySelector(\'input[name=sort_by]\');
        let sortDirection = document.querySelector(\'input[name=sort_direction]\');
        ...
        return false;
    " class="flex items-center gap-1 hover:text-blue-700">'.$label.' '.$arrow.'</a>';
}
@endphp
</script>
@endsection