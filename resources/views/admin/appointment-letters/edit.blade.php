        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('admin.appointment-letters.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-300 transition-all duration-200">
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <form action="{{ route('admin.appointment-letters.update', $appointmentLetter->id) }}" method="POST" enctype="multipart/form-data" id="appointment-letter-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <div class="mb-5">
                                    ...
                                    <select id="customer_id" name="customer_id" class="w-full border border-gray-300 rounded-lg text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm @error('customer_id') border-red-500 @enderror" required>
                                        <option value="">Select a customer</option>
                                        @foreach($customers as $customer)
                                            <option value="{{ $customer->id }}" {{ old('customer_id', $appointmentLetter->customer_id) == $customer->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="date" id="upload_date" name="upload_date" value="{{ old('upload_date', $appointmentLetter->upload_date->format('Y-m-d')) }}" class="w-full border border-gray-300 rounded-lg text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm @error('upload_date') border-red-500 @enderror" required>
                                    @error('upload_date')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="date" id="appointment_date" name="appointment_date" value="{{ old('appointment_date', $appointmentLetter->appointment_date ? $appointmentLetter->appointment_date->format('Y-m-d') : '') }}" class="w-full border border-gray-300 rounded-lg text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm @error('appointment_date') border-red-500 @enderror" required>
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="time" id="appointment_time" name="appointment_time" value="{{ old('appointment_time', $appointmentLetter->appointment_time ? $appointmentLetter->appointment_time->format('H:i') : '') }}" class="w-full border border-gray-300 rounded-lg text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm @error('appointment_time') border-red-500 @enderror" required>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                                        <div class="space-y-1 text-center">
                                            ...
                                            <p class="text-sm text-gray-600 mt-2" id="current-file">Current file: {{ basename($appointmentLetter->file_path) }}</p>
                            ...
                            <div>
                                <div class="mb-5">
                                    ...
                                    <textarea id="description" name="description" rows="8" class="w-full border border-gray-300 rounded-lg text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm @error('description') border-red-500 @enderror">{{ old('description', $appointmentLetter->description) }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
...
@section('scripts')
    ...
    {{-- Removed old script section content as it's now handled in the main content section's script block --}}
    <script>
        // document.addEventListener('DOMContentLoaded', function() {
