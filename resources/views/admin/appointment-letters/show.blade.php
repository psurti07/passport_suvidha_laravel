...
@section('title', 'Appointment Letter Details')
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                <div class="flex flex-wrap justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">Viewing details for appointment letter #{{ $appointmentLetter->id }}</p>
                    </div>
                    
                    <div class="flex space-x-2 mt-4 sm:mt-0">
                        <a href="{{ route('admin.appointment-letters.edit', $appointmentLetter->id) }}" 
                        ...
                        <a href="{{ route('admin.appointment-letters.download', $appointmentLetter->id) }}" 
                        ...
                        <form action="{{ route('admin.appointment-letters.destroy', $appointmentLetter->id) }}" 
                              method="POST" 
                ...
                <div class="bg-gray-50 rounded-lg p-6 mt-6">
                                ...
                                <div class="flex items-start">
                                    <div class="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                                        <span class="text-blue-700 font-semibold text-lg">
                                            {{ substr($appointmentLetter->customer->name, 0, 1) }}
                                        </span>
                                    </div>
                                    <div class="ml-4">
                                        <h4 class="text-lg font-medium text-gray-900">{{ $appointmentLetter->customer->name }}</h4>
                                        <p class="text-gray-500">{{ $appointmentLetter->customer->email }}</p>
                                        @if($appointmentLetter->customer->phone)
                                            <p class="text-gray-500">{{ $appointmentLetter->customer->phone }}</p>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 pt-4 border-t border-gray-100">
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p class="text-sm font-medium">{{ $appointmentLetter->customer->id }}</p>
                                        </div>
                                        <div>
                                            <p class="text-xs text-gray-500">Joined</p>
                                            <p class="text-sm font-medium">{{ $appointmentLetter->customer->created_at->format('M d, Y') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white shadow-sm rounded-lg p-4 border border-gray-100">
                                <div class="flex items-center mb-4">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <p class="text-xs text-gray-500">{{ strtoupper(pathinfo($appointmentLetter->file_path, PATHINFO_EXTENSION)) }} File</p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="text-sm font-medium">{{ $appointmentLetter->upload_date->format('M d, Y') }}</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500">Appointment Date</p>
                                        <p class="text-sm font-medium">{{ $appointmentLetter->appointment_date ? $appointmentLetter->appointment_date->format('M d, Y') : 'Not specified' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500">Appointment Time</p>
                                        <p class="text-sm font-medium">{{ $appointmentLetter->appointment_time ? $appointmentLetter->appointment_time->format('h:i A') : 'Not specified' }}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-medium">{{ $appointmentLetter->uploader->name }}</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500">Last Updated</p>
                                        <p class="text-sm font-medium">{{ $appointmentLetter->updated_at->format('M d, Y h:i A') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @if($appointmentLetter->description)
                        <div class="mt-6">
                            <h3 class="text-md font-semibold text-gray-800 mb-4">Description</h3>
                            <div class="bg-white shadow-sm rounded-lg p-4 border border-gray-100">
                                <p class="text-gray-700 whitespace-pre-line">{{ $appointmentLetter->description }}</p>
                            </div>
                        </div>
                    @endif
                </div>
