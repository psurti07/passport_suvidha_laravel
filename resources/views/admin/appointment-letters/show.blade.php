            ...
            <div class="flex flex-wrap justify-between items-center mb-6">
                ...
                <div class="flex space-x-2 mt-4 sm:mt-0">
                    ...
                    <form action="{{ route('admin.appointment-letters.destroy', $appointmentLetter->id) }}"
                        method="POST" class="inline delete-form" data-name="This appointment letter">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg font-medium text-gray-900">
                                        {{ $appointmentLetter->customer->name }}</h4>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-medium">
                                            {{ $appointmentLetter->customer->created_at->format('M d, Y') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white shadow-sm rounded-lg p-4 border border-gray-100">
                            <div class="flex items-center mb-4">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-xs text-gray-500">
                                        {{ strtoupper(pathinfo($appointmentLetter->file_path, PATHINFO_EXTENSION)) }}
                                        File</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm font-medium">
                                        {{ $appointmentLetter->upload_date->format('M d, Y') }}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500">Appointment Date</p>
                                    <p class="text-sm font-medium">
                                        {{ $appointmentLetter->appointment_date ? $appointmentLetter->appointment_date->format('M d, Y') : 'Not specified' }}
                                    </p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500">Appointment Time</p>
                                    <p class="text-sm font-medium">
                                        {{ $appointmentLetter->appointment_time ? $appointmentLetter->appointment_time->format('h:i A') : 'Not specified' }}
                                    </p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium">
                                        {{ $appointmentLetter->updated_at->format('M d, Y h:i A') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
