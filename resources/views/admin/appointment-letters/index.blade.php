    ...
    <div class="mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                <form id="filterForm" action="{{ route('admin.appointment-letters.index') }}" method="GET">
                                    ...
                                    @forelse($appointmentLetters as $letter)
                                        <tr
                                                ...
                                                <div class="flex items-center">
                                                    <div>
                                                        <div class="text-sm font-medium text-gray-900">
                                                            {{ $letter->customer->first_name }}
                                                            {{ $letter->customer->last_name }}
                                                        </div>
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ $letter->customer->mobile_number }}
                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                                @if($letter->appointment_date)
                                                    {{ $letter->appointment_date->format('d/m/Y') }} at {{ $letter->appointment_date->format('h:i A') }}
                                                @else
                                                    Not scheduled
                                                @endif
                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ $letter->upload_date->format('d/m/Y') }}
                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ $letter->uploader->name ?? 'System' }}
                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm">
                                                <div class="flex items-center space-x-3">
                                                    <a href="{{ route('admin.appointment-letters.preview', $letter->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.appointment-letters.edit', $letter->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.appointment-letters.download', $letter->id) }}"
                                                    ...
                                                    <button onclick="confirmDelete('{{ $letter->id }}')"
                ...
                <div class="mt-6 px-4 sm:px-0 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-4">
                        @if ($appointmentLetters->total() > 0)
                            <p class="text-sm text-gray-500">
                                Showing
                                <span class="font-medium">{{ $appointmentLetters->firstItem() }}</span>
                                to
                                <span class="font-medium">{{ $appointmentLetters->lastItem() }}</span>
                                of
                                <span class="font-medium">{{ $appointmentLetters->total() }}</span>
                                results
                            </p>
                        @endif
                    </div>
                    <div>
                        {{ $appointmentLetters->appends(request()->query())->links() }}
                    </div>
                </div>
            </div>
        </div>
