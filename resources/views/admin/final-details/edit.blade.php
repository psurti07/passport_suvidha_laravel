        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                <div class="flex justify-between items-center mb-6">
                    <h2
                        class="text-xl sm:text-2xl mb-3 md:mb-0 md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                        Edit Final Detail
                    </h2>
                ...
                <form action="{{ route('admin.final-details.update', $finalDetail) }}" method="POST"
                    ...
                    <div class="space-y-6">
                        ...
                        {{-- Document File --}}
                        <div>
                            <label for="file" class="block text-sm font-medium text-gray-700 mb-1">Document (PDF, JPG,
                                JPEG,
                                PNG)</label>

                            @if ($finalDetail->file_path)
                                <div class="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-100">
                                    <div class="flex flex-col md:flex-row items-lefts">
                                        ...
                                        <a href="{{ Storage::url($finalDetail->file_path) }}" target="_blank"
                                            class="text-blue-600 hover:underline ml-0 md:ml-2">
