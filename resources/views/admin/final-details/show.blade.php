...
@section('title', 'View Final Detail')
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin.final-details.edit', $finalDetail) }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg text-sm font-medium hover:from-blue-700 hover:to-blue-900 transition-all duration-200 shadow-md hover:shadow-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                        Edit
                    </a>
                    <a href="{{ route('admin.final-details.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-300 transition-all duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-8 border border-gray-100 rounded-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 border-b border-gray-100 flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-xs text-gray-500">Uploaded: {{ $finalDetail->upload_date ? $finalDetail->upload_date->format('d/m/Y H:i:s') : 'N/A' }}</p>
                        <p class="text-xs text-gray-500">Last Updated: {{ $finalDetail->updated_at->format('d/m/Y H:i:s') }}</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 border-t border-gray-100">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg border border-gray-100 flex justify-center items-center">
                        <div class="flex space-x-4">
                            <a href="{{ Storage::url($finalDetail->file_path) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg text-sm font-medium hover:from-blue-700 hover:to-blue-900 transition-all duration-200 shadow-md hover:shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="{{ Storage::url($finalDetail->file_path) }}" download class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-300 transition-all duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
