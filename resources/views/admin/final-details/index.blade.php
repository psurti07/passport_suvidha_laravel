            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <form id="filterForm">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-center mb-6">
                        <div class="flex items-center gap-4">
                            <h2
                                class="text-xl sm:text-2xl md:mb-6 mb-3 md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                                FINAL DETAILS
                            </h2>
                        </div>
                        <div class="flex flex-wrap gap-2 lg:gap-3">
                            ...
                            <div>
                                ...
                                <select id="is_approved" class="border rounded-lg px-3 py-2 text-sm sm:w-32">
                ...
                <div class="mt-4 overflow-x-auto">
                    <div class="text-sm text-gray-700">
                        ...
                        <table id="final-details-table" class="min-w-full divide-y divide-gray-200">
                            ...
                            <thead class="bg-blue-50">
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Uploaded
                                        By
                                    </th>
...
@push('scripts')
    <script>
        $(function() {
            ...
            let table = $('#final-details-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.final-details.data') }}",
                    data: function(d) {
                ...
                columns: [{
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            let total = meta.settings._iRecordsDisplay; // filtered total rows
