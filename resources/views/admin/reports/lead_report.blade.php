                    ...
                    <table id="lead-reports-table" class="min-w-full divide-y divide-gray-200 border-separate">
                        <thead class="bg-blue-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 !text-right text-xs font-semibold text-gray-600 uppercase">Total Leads
                                </th>
                ...
                <table class="w-full border text-sm">
                    <thead class="bg-blue-50">
                        <tr>
                            ...
                            <th class="border text-gray-600 font-semibold !text-right p-4 uppercase">Leads</th>
                        </tr>
                    </thead>
                    <tbody>
            `;
