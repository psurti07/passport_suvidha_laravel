        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-4 lg:p-8">
                ...
                <div class="mt-4 text-sm text-gray-700">
                    ...
                    <table id="invoice-reports-table" class="min-w-full divide-y divide-gray-200 border-separate">
                        <thead class="bg-blue-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 !text-right text-xs font-semibold text-gray-600 uppercase">Total Amount
                                </th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#invoice-reports-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.report.invoice') }}",
        ...
        $(document).on('click', '.view-month', function() {
            ...
            $.ajax({
                url: "{{ route('admin.report.invoice.month.details') }}",
                type: "GET",
                dataType: "json",
                data: {
                    year,
            ...
            `;
                    ...
                    if (res.data && res.data.length > 0) {
                        ...
                        <tr>
                            ...
                            <td class="border text-gray-700 p-4 !text-right">${row.total_amount ?? 0}</td>
                        </tr>
                    `;
                        });
                    } else {
                ...
                `;
                    ...
                    <tfoot>
                        <tr>
                            <th class="border text-gray-600 font-bold p-4 !text-right">Total</th>
                            <th class="border text-gray-600 font-bold p-4 !text-right">${res.grand_total ?? 0}</th>
                        </tr>
                    </tfoot>
                </table>
            `;
