        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <form id="filterForm">
                    ...
                    <div class="flex flex-col xl:flex-row justify-between items-center mb-6">
                        <div class="flex items-center gap-4">
                            <h2
                                class="text-xl md:mb-6 mb-3 sm:text-2xl md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <div>
                                ...
                                <select id="status" class="border rounded-lg px-3 py-2 text-sm sm:w-32 w-[150px]">
                ...
                <div class="mt-4 overflow-x-auto">
                    <div class="whitespace-nowrap text-sm text-gray-700">
                        ...
                        <table id="customer-support-table" class="min-w-full divide-y divide-gray-200 pt-5">
                            ...
                            <thead class="bg-blue-50">
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Subject
                                    </th>
...
@push('scripts')
    <script>
        $(function() {
            ...
            let table = $('#customer-support-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.support.customer.data') }}",
                    data: function(d) {
