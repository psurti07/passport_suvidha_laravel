...
<div class="mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    {{-- Main Content Grid --}}
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:items-start"> {{-- Added lg:items-start to prevent columns stretching --}}
            ...
            <div>
                ...
                <dl class="space-y-4">
                    ...
                    <div class="flex justify-between">
                        ...
                        <dd class="text-sm text-gray-900 font-semibold">{{ optional($ticket->customer)->mobile ?? 'N/A' }}</dd> {{-- Updated to check customer relation --}}
                    </div>
                    <div class="flex justify-between">
                     ...
                     <div class="flex justify-between">
                        ...
                        {{-- User/Customer should be loaded in controller if needed --}}
                        <dd class="text-sm text-gray-900 font-semibold">{{ optional($ticket->customer)->card_no ?? 'N/A' }}</dd> {{-- Updated to check customer relation --}}
                    </div>
                </dl>
            </div>
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-lg border border-gray-100 p-6 space-y-6">
            ...
            <div>
                 <h3 class="text-md font-medium text-gray-700 mb-3 border-t pt-4">Staff Remarks</h3> {{-- Added border-t and padding --}}

                 {{-- Display existing remarks --}}
                 <div class="mb-4 space-y-3 max-h-72 overflow-y-auto pr-2 border rounded-md p-3 bg-gray-50"> {{-- Added some styling to the container --}}
