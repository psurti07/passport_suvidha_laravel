            ...
            <div class="p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-center mb-6">
                        ...
                        <div class="flex flex-wrap gap-2 lg:gap-3">
                            ...
                            <div>
                                ...
                                <select id="is_customer" class="border rounded-lg px-3 py-2 text-sm sm:w-32 w-[150px]">
                ...
                <div class="mt-4 overflow-x-auto">
                    <div class="whitespace-nowrap text-sm text-gray-700">
                        ...
                        <table id="card-offers-table" class="min-w-full divide-y divide-gray-200 pt-5">
...
@push('scripts')
    <script>
        $(function() {
            ...
            let table = $('#card-offers-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.card-offers.data') }}",
                    data: function(d) {
