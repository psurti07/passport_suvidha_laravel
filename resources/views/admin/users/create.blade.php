            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="p-8 p-0">
                    <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6" novalidate>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 hidden peer-invalid:block"
                        ...
                        {{-- Form Actions --}}
                        <div class="flex flex-col gap-1 md:flex-row items-end justify-end pt-6 border-t border-gray-200">
                            ...
                            <button type="submit"
                                ...
                                class="inline-flex items-end px-6 py-2 border border-transparent rounded-xl shadow-sm text-sm font-medium text-gray-900 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-200">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
