        ...
        <div class="mt-6">
            ...
            <dl class="divide-y divide-gray-200">
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                    ...
                    @else
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 font-semibold">LEAD CUSTOMER</dd>
                    @endif
                </div>
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                    <dt class="text-sm font-medium text-gray-500">Mobile</dt>
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        {{ $customer->mobile_number ?? 'N/A' }}</dd>
            ...
            <div x-data="convertCustomerComponent({{ $errors->any() ? 'true' : 'false' }})">
                <div class="mt-6 pt-4 border-t border-gray-200 flex justify-end">
                    <button type="button" @click="showCustomerForm = !showCustomerForm"
                        ...
                        <span x-text="showCustomerForm ? 'Close' : 'Convert to Customer &rarr;'">Convert to Customer
                            &rarr;</span>
                    </button>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" id="city" name="city" value="{{ old('city', $customer->city) }}"
                                    required placeholder="Enter city" readonly
                                    class="block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm py-2 px-3 hover:border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-all duration-200 placeholder-gray-400 sm:text-sm">
                                @error('city')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" id="state" name="state" value="{{ old('state', $customer->state) }}"
                                    required placeholder="Enter state" readonly
                                    class="block w-full rounded-lg border-2 border-gray-200 bg-white shadow-sm py-2 px-3 hover:border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-all duration-200 placeholder-gray-400 sm:text-sm">
                                @error('state')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                <label for="service_id" class="block text-sm font-medium text-gray-700 mb-1">Service
