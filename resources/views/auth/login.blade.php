...
<head>
    ...
    .auth-logo::after {
        ...
        position: absolute;
        inset: -3px;
        border: 2px solid rgb(0 51 102 / 0.1);
        border-radius: 18px;
        opacity: 0.1;
    }
    ...
    <div class="auth-wrapper">
        <div class="auth-container">
            <div class="auth-inner">
                <div class="auth-logo">
                    <img src="{{ asset('assets/logo/passport-suvidha-icon.png') }}" height="100" width="100"
                        class="img-fluid mx-auto d-block" style="max-width:180px;" alt="Passport Suvidha" />
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" type="email" name="email"
                            class="form-input @error('email') border-red-300 @enderror" placeholder="Enter your email"
