...
@section('content')
    ...
    <div class="max-w-8xl mx-auto py-6 px-4 sm:px-6 lg:px-8 bg-white rounded-lg shadow-md my-8">
        <h1 class="text-center text-xl md:text-2xl font-semibold text-blue-900 mb-8">Today's Statistics - {{ $currentDate }}
        </h1>

        <h2 class="mt-8 mb-4 text-md md:text-lg font-medium text-blue-900 border-b border-gray-200 pb-2">Customer's
            Statistics</h2>
        ...
        <h2 class="mt-8 mb-4 text-md md:text-lg font-medium text-blue-900 border-b border-gray-200 pb-2">Appointment's
            Statistics</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <h2 class="mt-8 mb-4 text-md md:text-lg font-medium text-blue-900 border-b border-gray-200 pb-2">OTP's Statistics
        </h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <h2 class="mt-8 mb-4 text-md md:text-lg font-medium text-blue-900 border-b border-gray-200 pb-2">Ticket's Statistics
        </h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {{-- <h2 class="mt-8 mb-4 text-md md:text-lg font-medium text-blue-900 border-b border-gray-200 pb-2">Payment & Offers Statistics</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
