...
scrollToActive()" x-cloak>
        ...
        <aside class="sidebar" :class="{ 'collapsed': sidebarCollapsed, 'active': isMobileMenuOpen }">
            ...
            <nav class=" px-3">
                ...
                <div x-data="{ todayDataOpen: {{ $todayDataActive ? 'true' : 'false' }} }">
                    ...
                    <button type="button" @click="todayDataOpen = !todayDataOpen" class="nav-link flex items-center justify-between w-full px-4 py-3 rounded-lg mb-1
                    ...
                    <div x-show="todayDataOpen" x-transition class="ml-4 pl-4 border-l border-gray-300">
                        ...
                        <!-- Today Statistics -->
                        <a href="{{ route('admin.todaystatistics') }}" class="nav-link flex items-center px-4 py-2.5 rounded-lg mb-1
                {{ request()->routeIs('admin.todaystatistics') ? 'active' : '' }}"
                        ...
                        <!-- Today's Leads -->
                        <a href="{{ route('admin.leads.today') }}" class="nav-link flex items-center px-4 py-2.5 rounded-lg mb-1
                {{ request()->routeIs('admin.leads.today') ? 'active' : '' }}"
                        ...
                        <!-- Today's Customers -->
                        <a href="{{ route('admin.customers.today') }}" class="nav-link flex items-center px-4 py-2.5 rounded-lg mb-1
                ...
                class="nav-link flex items-center px-4 py-3 rounded-lg mb-1
                {{ request()->routeIs('admin.todaystatistics') ? 'active' : '' }}"
                x-bind:title="sidebarCollapsed ? 'Today Statistics' : ''">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    --}}
                ...
                <a href="{{ route('admin.report.lead') }}"
                    ...
                    <span class="nav-link-text font-semibold text-lg">Lead</span>
                </a>
    ...
    --}}
                ...
                <a href="{{ route('admin.phonepe-logs.index') }}"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 {{ request()->routeIs('admin.phonepe-logs.*') ? 'active' : '' }}"
                    x-bind:title="sidebarCollapsed ? 'PhonePe Log' : ''">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <rect x="2" y="5" width="20" height="14" rx="2" ry="2" stroke-width="2"></rect>
                        <line x1="2" y1="10" x2="22" y2="10" stroke-width="2"></line>
                    </svg>
