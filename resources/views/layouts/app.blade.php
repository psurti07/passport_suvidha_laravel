...
scrollToActive()" x-cloak>
        ...
        <aside class="sidebar" :class="{ 'collapsed': sidebarCollapsed, 'active': isMobileMenuOpen }">
            ...
            <nav class=" px-3">
                ...
                {{ request()->routeIs('admin.todaystatistics') ? 'active' : '' }}"
                        ...
                        <a href="{{ route('admin.todayprocesssteps') }}"
                            class="nav-link flex items-center px-4 py-2.5 rounded-lg mb-1
                {{ request()->routeIs('admin.todayprocesssteps') ? 'active' : '' }}"
                            x-bind:title="sidebarCollapsed ? 'Today\'s Process Steps' : ''">
    ...
    {{ request()->routeIs('admin.customers.pov-success-15d') ? 'active' : '' }}"
            ...
            a11.955 11.955 0 01-9.618 3.04A12.02 12.02 0 003 12
            c0 5.591 3.824 10.291 9 11.622
            5.176-1.331 9-6.031 9-11.622
