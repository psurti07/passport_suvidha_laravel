...
<div class="mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100">
        <div class="p-4 sm:p-6 lg:p-8">
            <form id="filterForm" action="<?php echo e(route('admin.otps.index')); ?>" method="GET">
                ...
                <div class="flex flex-col lg:flex-row justify-between items-center mt-6 gap-4">
                     <div class="flex flex-wrap items-center gap-2 space-x-2">
                         ...
                         <button type="button" onclick="copyToClipboard()"
                            ...
                            <a href="<?php echo e(route('admin.otps.export', ['type' => 'excel'] + request()->all())); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md hover:bg-gray-100 transition-colors duration-150">
                                Excel
                            </a>
                            <a href="<?php echo e(route('admin.otps.export', ['type' => 'csv'] + request()->all())); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md hover:bg-gray-100 transition-colors duration-150">
                                CSV
                            </a>
                            <a href="<?php echo e(route('admin.otps.export', ['type' => 'pdf'] + request()->all())); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md hover:bg-gray-100 transition-colors duration-150">
                                PDF
                            </a>
                        </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 relative">
                            <thead class="bg-blue-50">
                                <tr>
                                    ...
                                    <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                        <?php echo sortLink('mobile_number', 'Mobile Number'); ?>
                                    ...
                                    <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                        <?php echo sortLink('sent_at', 'Sent At'); ?>

                                    </th>
                                    <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                        <?php echo sortLink('is_verified', 'Status'); ?>
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors duration-150">
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($otp->id); ?></td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($otp->mobile_number); ?></td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($otp->otp); ?></td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($otp->sent_at->format('Y-m-d H:i:s')); ?></td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm">
                                        <?php if($otp->is_verified): ?>
            ...
            <div class="mt-6 px-4 sm:px-0 flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div class="flex items-center gap-4">
                    <?php if($otps->total() > 0): ?>
                        <p class="text-sm text-gray-500">
                            Showing
                            <span class="font-medium"><?php echo e($otps->firstItem()); ?></span>
                            to
                            <span class="font-medium"><?php echo e($otps->lastItem()); ?></span>
                            of
                            <span class="font-medium"><?php echo e($otps->total()); ?></span>
                            results
                        </p>
                    <?php endif; ?>
                    ...
                    <?php if($otps->total() > ($options[0] ?? 10)): ?>
                        <div class="flex items-center gap-2">
                ...
                <div>
                    <?php if($otps->hasPages()): ?>
                        <?php echo e($otps->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/otps/index.blade.php ENDPATH**/ ?>