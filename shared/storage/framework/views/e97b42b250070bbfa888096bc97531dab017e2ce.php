<?php $__env->startSection('title', 'View Predefined Message'); ?>
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center space-x-3">
                    <a href="<?php echo e(route('admin.predefined-messages.edit', ['predefined_message' => $preDefinedMessage->id])); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg text-sm font-medium hover:from-blue-700 hover:to-blue-900 transition-all duration-200 shadow-md hover:shadow-lg">
            ...
            <div class="mt-8 border border-gray-100 rounded-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 border-b border-gray-100 flex items-center">
                    <span class="bg-gradient-to-r from-blue-600 to-blue-800 text-white text-lg font-semibold px-4 py-2 rounded-lg shadow-sm">
                        #<?php echo e($preDefinedMessage->id); ?>

                    </span>
                    <div class="ml-4">
                        <p class="text-xs text-gray-500">Created: <?php echo e($preDefinedMessage->created_at->format('d/m/Y H:i:s')); ?></p>
                        <p class="text-xs text-gray-500">Last Updated: <?php echo e($preDefinedMessage->updated_at->format('d/m/Y H:i:s')); ?></p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="ml-7">
                            <p class="text-gray-800 bg-gray-50 p-3 rounded-lg border border-gray-100"><?php echo e($preDefinedMessage->message_name); ?></p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="ml-7">
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100 whitespace-pre-wrap text-gray-800"><?php echo e($preDefinedMessage->message_remarks); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 flex justify-end">
                <form action="<?php echo e(route('admin.predefined-messages.destroy', ['predefined_message' => $preDefinedMessage->id])); ?>" method="POST" class="inline delete-predefined-message-form">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/predefmessages/show.blade.php ENDPATH**/ ?>