    ...
    <div class="mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                <form id="filterForm" action="<?php echo e(route('admin.predefined-messages.index')); ?>" method="GET">
                    <div class="flex flex-col lg:flex-row justify-between items-center space-y-4 sm:space-y-0">
                        <div class="flex items-center gap-4">
                            ...
                            <a href="<?php echo e(route('admin.predefined-messages.create')); ?>"
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-center mt-6 gap-4">
                        <div class="flex flex-wrap items-center gap-2 space-x-2">
                            ...
                            <a href="<?php echo e(route('admin.predefined-messages.export', ['type' => 'excel'] + request()->all())); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md">
                                Excel
                            </a>
                            <a href="<?php echo e(route('admin.predefined-messages.export', ['type' => 'csv'] + request()->all())); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md">
                                CSV
                            </a>
                            <a href="<?php echo e(route('admin.predefined-messages.export', ['type' => 'pdf'] + request()->all())); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md">
                                PDF
                            </a>
                        </div>
                ...
                <script>
                    ...
                    function showToast(message, type = 'success') {
                        ...
                        toastNode.className = `toast-content flex items-center w-full max-w-sm p-4 mb-4 ${bgColorClass} ${textColorClass} rounded-lg shadow-2xl border ${borderColorClass} backdrop-blur toast-enter`;
                        toastNode.innerHTML = `
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        const deleteForms = document.querySelectorAll('.delete-predefined-message-form');
                ...
                <?php
                    ...
                    function sortLink($column, $label)
                    {
                        ...
                        // Update route name
                        return '<a href="' . route('admin.predefined-messages.index', $queryParams) . '" class="flex items-center hover:text-blue-700">' . $label . $icon . '</a>';
                    }
                ?>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 relative">
                                <thead class="bg-blue-50">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('message_name', 'Message Name'); ?>

                                        </th>
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('message_remarks', 'Remarks'); ?>
                                        ...
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('updated_at', 'Updated At'); ?>
                                ...
                                <tbody class="bg-white">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $preDefinedMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr
                                            ...
                                            <td class="px-4 py-4 whitespace-normal text-sm text-gray-700 max-w-xs break-words">
                                                <?php echo e($message->message_name); ?>

                                            </td>
                                            <td class="px-4 py-4 whitespace-normal text-sm text-gray-700 max-w-md break-words">
                                                <?php echo e(Str::limit($message->message_remarks, 150)); ?> 
                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700">
                                                <?php echo e($message->created_at->format('d/m/Y H:i:s')); ?>

                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700">
                                                <?php echo e($message->updated_at->format('d/m/Y H:i:s')); ?>

                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm">
                                                <div class="flex items-center space-x-3">
                                                    
                                                    <a href="<?php echo e(route('admin.predefined-messages.show', ['predefined_message' => $message->id])); ?>"
                                                        class="text-blue-600 hover:text-blue-900" title="View Message">
                                                    ...
                                                    <a href="<?php echo e(route('admin.predefined-messages.edit', ['predefined_message' => $message->id])); ?>"
                                                        class="text-yellow-600 hover:text-yellow-900" title="Edit Message">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                            viewBox="0 0 20 20" fill="currentColor">
                                                            <path
                                                    ...
                                                    <form action="<?php echo e(route('admin.predefined-messages.destroy', ['predefined_message' => $message->id])); ?>"
                                                        method="POST" class="inline delete-predefined-message-form">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="submit"
                                                            class="text-red-600 hover:text-red-900" title="Delete Message">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                                viewBox="0 0 20 20" fill="currentColor">
                                                                <path fill-rule="evenodd"
                                        ...
                                        <tr>
                                            <td colspan="6" class="px-6 py-10 text-center"> 
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="mt-4 text-gray-500 text-sm font-medium">No predefined messages found</p>
                                                    <p class="mt-1 text-gray-400 text-xs">Try adjusting your search or filter.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                ...
                <div class="mt-6 px-4 sm:px-0 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <?php if($preDefinedMessages->total() > 0): ?>
                            <p class="text-sm text-gray-500">
                                Showing
                                <span class="font-medium"><?php echo e($preDefinedMessages->firstItem()); ?></span>
                                to
                                <span class="font-medium"><?php echo e($preDefinedMessages->lastItem()); ?></span>
                                of
                                <span class="font-medium"><?php echo e($preDefinedMessages->total()); ?></span>
                                results
                            </p>
                        <?php endif; ?>
                        <?php $options = [10, 25, 50, 100]; ?>
                        
                        <?php if($preDefinedMessages->total() > ($options[0] ?? 10)): ?>
                    ...
                    <div>
                        ...
                        <?php if($preDefinedMessages->hasPages()): ?>
                            <?php echo e($preDefinedMessages->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/predefmessages/index.blade.php ENDPATH**/ ?>