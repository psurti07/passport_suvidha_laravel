    ...
    <div class="mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                <form id="filterForm" action="<?php echo e(route('admin.users.index')); ?>" method="GET">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-center mt-6 gap-4">
                        <div class="flex flex-wrap items-center gap-2 space-x-2">
                            ...
                            <a href="<?php echo e(route('admin.users.export', ['type' => 'excel'] + request()->all())); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md">
                                Excel
                            </a>
                            <a href="<?php echo e(route('admin.users.export', ['type' => 'csv'] + request()->all())); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md">
                                CSV
                            </a>
                            <a href="<?php echo e(route('admin.users.export', ['type' => 'pdf'] + request()->all())); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md">
                                PDF
                            </a>
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 relative">
                                <thead class="bg-blue-50">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('created_at', 'Date'); ?>

                                        </th>
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('name', 'Full Name'); ?>

                                        </th>
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('email', 'Email Id'); ?>
                                ...
                                <tbody class="bg-white">
                                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700">
                                                <?php echo e($user->updated_at->format('d/m/Y H:i:s')); ?>
                ...
                <div class="mt-6 px-4 sm:px-0 flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <?php if($users->total() > ($options[0] ?? 10)): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/users/index.blade.php ENDPATH**/ ?>