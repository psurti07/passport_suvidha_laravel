    ...
    <div class="mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                <form id="filterForm" action="<?php echo e(route('admin.reports.gst')); ?>" method="GET">
                    <div class="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
                        ...
                        <div class="flex flex-col lg:flex-row flex-wrap gap-4 lg:gap-2">
                            <div class="flex flex-col sm:flex-row items-center gap-2">
                                ...
                                <input type="date" name="from_date" class="border border-gray-300 rounded-lg text-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm w-full sm:w-40" value="<?php echo e(request('from_date')); ?>">
                            </div>
                            <div class="flex flex-col sm:flex-row items-center gap-2">
                                <label class="text-sm font-medium text-gray-700 whitespace-nowrap">To:</label>
                                <input type="date" name="to_date" class="border border-gray-300 rounded-lg text-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm w-full sm:w-40" value="<?php echo e(request('to_date')); ?>">
                            </div>
                            <input type="hidden" name="sort_by" value="<?php echo e(request('sort_by', 'inv_date')); ?>">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-center mt-6 gap-4">
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <a href="<?php echo e(route('admin.reports.gst', ['export' => 'excel'] + request()->all())); ?>" class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md border border-gray-200 hover:bg-gray-50">
                                Excel
                            </a>
                            <a href="<?php echo e(route('admin.reports.gst', ['export' => 'csv'] + request()->all())); ?>" class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md border border-gray-200 hover:bg-gray-50">
                                CSV
                            </a>
                            <a href="<?php echo e(route('admin.reports.gst', ['export' => 'pdf'] + request()->all())); ?>" class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md border border-gray-200 hover:bg-gray-50">
                                PDF
                            </a>
                        </div>
                        <div class="flex items-center gap-2 w-full lg:w-auto">
                            <label for="searchInput" class="text-sm font-medium text-gray-700">Search:</label>
                            <input type="text" id="searchInput" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search report..." class="border border-gray-300 rounded-lg text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm flex-grow">
                        </div>
                    </div>
                </form>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 relative">
                                <thead class="bg-blue-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('inv_date', 'INV Date'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('inv_no', 'INV #'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-right text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('net_amount', 'Net Amount'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-right text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('cgst', 'CGST'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-right text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('sgst', 'SGST'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-right text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('igst', 'IGST'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-right text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('total_amount', 'Total Amount'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('fullname', 'Fullname'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('mobile', 'Mobile'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('email', 'Email'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('gst_no', 'GST No'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('city', 'City'); ?></th>
                                        <th scope="col" class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200"><?php echo sortLink('state', 'State'); ?></th>
                                        
                                        
                                    </tr>
                                </thead>
                                <tbody class="bg-white">
                                    <?php $__empty_1 = true; $__currentLoopData = $paginatedData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors duration-150">
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($paginatedData->firstItem() + $index); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($item['inv_date'] ? \Carbon\Carbon::parse($item['inv_date'])->format('d/m/Y') : ''); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($item['inv_no'] ?? ''); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-right text-gray-700"><?php echo e(number_format($item['net_amount'] ?? 0, 2)); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-right text-gray-700"><?php echo e(number_format($item['cgst'] ?? 0, 2)); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-right text-gray-700"><?php echo e(number_format($item['sgst'] ?? 0, 2)); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-right text-gray-700"><?php echo e(number_format($item['igst'] ?? 0, 2)); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-right text-gray-700"><?php echo e(number_format($item['total_amount'] ?? 0, 2)); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($item['fullname'] ?? ''); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($item['mobile'] ?? ''); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e(strtolower($item['email'] ?? '')); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($item['gst_no'] ?? ''); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($item['city'] ?? ''); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($item['state'] ?? ''); ?></td>                                                                                        
                                        </tr>
                ...
                <div class="mt-6 px-4 sm:px-0 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-4">
                        <?php if($paginatedData->total() > 0): ?>
                            <p class="text-sm text-gray-500">
                                Showing <span class="font-medium"><?php echo e($paginatedData->firstItem()); ?></span> to <span class="font-medium"><?php echo e($paginatedData->lastItem()); ?></span> of <span class="font-medium"><?php echo e($paginatedData->total()); ?></span> results
                            </p>
                        <?php endif; ?>
                        <?php $options = [10, 25, 50, 100]; ?>
                        <?php if($paginatedData->total() > ($options[0] ?? 10)): ?>
                    ...
                    <div>
                        <?php if($paginatedData->hasPages()): ?>
                            <?php echo e($paginatedData->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/reports/gst_report.blade.php ENDPATH**/ ?>