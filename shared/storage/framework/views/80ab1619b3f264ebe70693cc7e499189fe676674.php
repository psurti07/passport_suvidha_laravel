<?php $__env->startSection('title', 'Create Document Type'); ?>
    ...
    <div class="mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <form action="<?php echo e(route('admin.document-types.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-6">
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Enter document type description"><?php echo e(old('description')); ?></textarea>
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" 
                                       ...
                                       name="is_mandatory" 
                                       value="1" 
                                       <?php echo e(old('is_mandatory', true) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/document-types/create.blade.php ENDPATH**/ ?>