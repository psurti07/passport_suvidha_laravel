<?php $__env->startSection('title', 'Document Types'); ?>
    ...
    <div class="mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                <form id="filterForm" action="<?php echo e(route('admin.document-types.index')); ?>" method="GET">
                    <div class="flex flex-col lg:flex-row justify-between items-center space-y-4 sm:space-y-0">
                        <div class="flex items-center gap-4">
                            ...
                            <a href="<?php echo e(route('admin.document-types.create')); ?>"
                ...
                <script>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        const deleteForms = document.querySelectorAll('.delete-document-type-form');
                ...
                <?php
                    ...
                    function sortLink($column, $label) {
                        ...
                        return '<a href="' . route('admin.document-types.index', $queryParams) . '" class="flex items-center hover:text-blue-700">' . $label . $icon . '</a>';
                    }
                ?>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 relative">
                                <thead class="bg-blue-50">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('name', 'Name'); ?>

                                        </th>
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('description', 'Description'); ?>

                                        </th>
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('is_mandatory', 'Mandatory'); ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $documentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $documentType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors duration-150">
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700">
                                                <?php echo e($documentType->id); ?>

                                            </td>
                                            <td class="px-4 py-4 whitespace-normal text-sm text-gray-700 max-w-xs break-words">
                                                <?php echo e($documentType->name); ?>

                                            </td>
                                            <td class="px-4 py-4 whitespace-normal text-sm text-gray-700 max-w-md break-words">
                                                <?php echo e(Str::limit($documentType->description, 150)); ?>

                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700">
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($documentType->is_mandatory ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                                    <?php echo e($documentType->is_mandatory ? 'Yes' : 'No'); ?>

                                                </span>
                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700">
                                                <?php echo e($documentType->created_at->format('d/m/Y H:i:s')); ?>

                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm">
                                                <div class="flex items-center space-x-3">
                                                    <a href="<?php echo e(route('admin.document-types.show', $documentType)); ?>"
                                                    ...
                                                    <a href="<?php echo e(route('admin.document-types.edit', $documentType)); ?>"
                                                    ...
                                                    <form action="<?php echo e(route('admin.document-types.destroy', $documentType)); ?>"
                                                        method="POST" class="inline delete-document-type-form">
                                                        <?php echo csrf_field(); ?>
                                        ...
                                        <tr>
                                            <td colspan="6" class="px-6 py-10 text-center">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="mt-4 text-gray-500 text-sm font-medium">No document types found</p>
                ...
                <div class="mt-6 px-4 sm:px-0 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-4">
                        <?php if($documentTypes->total() > 0): ?>
                            <p class="text-sm text-gray-500">
                                Showing
                                <span class="font-medium"><?php echo e($documentTypes->firstItem()); ?></span>
                                to
                                <span class="font-medium"><?php echo e($documentTypes->lastItem()); ?></span>
                                of
                                <span class="font-medium"><?php echo e($documentTypes->total()); ?></span>
                                results
                            </p>
                        <?php endif; ?>
                        <?php $options = [10, 25, 50, 100]; ?>
                        <?php if($documentTypes->total() > ($options[0] ?? 10)): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/document-types/index.blade.php ENDPATH**/ ?>