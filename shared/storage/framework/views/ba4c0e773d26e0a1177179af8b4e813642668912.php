            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between pb-6 border-b border-gray-100">
                    ...
                    <div class="text-sm text-gray-500">
                        User ID: <span class="font-medium text-gray-900">#<?php echo e($user->id); ?></span>
                    </div>
                </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($user->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <span class="w-1.5 h-1.5 inline-block rounded-full <?php echo e($user->is_active ? 'bg-green-400' : 'bg-red-400'); ?> mr-1.5"></span>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900"><?php echo e($user->creator->name ?? 'N/A'); ?></p>
                            </div>
                            <div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-gray-900"><?php echo e($role->name); ?></span>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/users/show.blade.php ENDPATH**/ ?>