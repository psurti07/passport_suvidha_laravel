...
<head>
    ...
    <title><?php echo e(config('app.name', 'Passport Suvidha')); ?></title>
                    ...
                    <div class="flex justify-between items-center h-full">
                        ...
                        <div class="user-info">
                            <?php if(auth()->guard()->check()): ?>
                                <span class="user-name">Hello, <span class="font-bold"><?php echo e(Auth::user()->name); ?></span></span>
        ...
        <aside class="sidebar" :class="{ 'collapsed': sidebarCollapsed, 'active': isMobileMenuOpen }">
            <div class="sidebar-header">
                <div class="flex items-center">
                    <span
                        class="text-xl font-semibold text-white sidebar-title-text"><?php echo e(config('app.name', 'Passport Suvidha')); ?></span>
                </div>
            </div>

            <nav class="mt-6 px-3">
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.todaystatistics')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.todaystatistics') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.reports.gst')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.reports.gst') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.customer.search.form')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.customer.search.*') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.customers.today')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.customers.today') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.customers.index')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.customers.*') && !request()->routeIs('admin.customers.today') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.otps.index')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.otps.*') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.support.customer')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.support.customer') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.support.guest')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.support.guest') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.final-details.index')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.final-details.*') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.appointment-letters.index')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.appointment-letters.*') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.predefined-messages.index')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.predefined-messages.*') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.document-types.index')); ?>"
                    class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.document-types.*') ? 'active' : ''); ?>"
                ...
                <?php if(Auth::check() && Auth::user()->isAdmin()): ?>
                    ...
                    <a href="<?php echo e(route('admin.users.index')); ?>"
                        class="nav-link flex items-center px-4 py-3 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>"
...
<?php /**PATH /var/www/laravel-app/releases/11/resources/views/layouts/app.blade.php ENDPATH**/ ?>