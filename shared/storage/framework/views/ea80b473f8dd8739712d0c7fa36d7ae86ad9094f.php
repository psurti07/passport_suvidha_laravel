...
<div class="max-w-2xl mx-auto px-4 py-6">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="p-6">
            <div class="mb-8">
                <h2 class="text-2xl font-bold text-gray-900">Edit Customer (#<?php echo e($customer->id); ?>)</h2>
                <p class="text-sm text-gray-500 mt-1">Update customer information</p>
            </div>

            <form method="POST" action="<?php echo e(route('admin.customers.update', $customer)); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               name="mobile_number" 
                               value="<?php echo e(old('mobile_number', $customer->mobile_number)); ?>" 
                               required 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center">
                    <input id="is_paid" name="is_paid" type="checkbox" value="1" <?php echo e(old('is_paid', $customer->is_paid) ? 'checked' : ''); ?> 
                ...
                <div x-data="{ isPaid: <?php echo e(old('is_paid', $customer->is_paid) ? 'true' : 'false'); ?> }" @paid-status-change.window="isPaid = $event.detail" x-show="isPaid" x-transition class="space-y-6 border-t border-gray-200 pt-6">
                    <p class="text-sm text-gray-500">Additional details for the paid customer:</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
...
unset($__errorArgs, $__bag); ?>" 
                                   name="pack_code" 
                                   value="<?php echo e(old('pack_code', $customer->pack_code)); ?>" 
                                   :required="isPaid" 
...
unset($__errorArgs, $__bag); ?>" 
                                   name="service_code" 
                                   value="<?php echo e(old('service_code', $customer->service_code)); ?>" 
                                   :required="isPaid" 
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                rows="3" 
                                :required="isPaid" 
                                placeholder="Enter full address"><?php echo e(old('address', $customer->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                   name="place_of_birth" 
                                   value="<?php echo e(old('place_of_birth', $customer->place_of_birth)); ?>" 
                                   :required="isPaid" 
...
unset($__errorArgs, $__bag); ?>" 
                               ...
                               value="<?php echo e(old('payment_info_id', $customer->payment_info_id)); ?>" 
                               :required="isPaid" 
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/customers/edit.blade.php ENDPATH**/ ?>