<?php $__env->startSection('title', 'Edit Predefined Message'); ?>
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                    Edit Predefined Message #<?php echo e($preDefinedMessage->id); ?>
            ...
            <form action="<?php echo e(route('admin.predefined-messages.update', ['predefined_message' => $preDefinedMessage->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="message_name" id="message_name" required value="<?php echo e(old('message_name', $preDefinedMessage->message_name)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Enter the content of the predefined message"><?php echo e(old('message_remarks', $preDefinedMessage->message_remarks)); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/predefmessages/edit.blade.php ENDPATH**/ ?>