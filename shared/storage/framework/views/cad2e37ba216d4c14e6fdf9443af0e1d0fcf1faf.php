...
<div class="mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100">
        <div class="p-4 sm:p-6 lg:p-8">
            <form id="filterForm" action="<?php echo e(route('admin.customers.today')); ?>" method="GET">
                ...
                <div class="flex flex-col lg:flex-row justify-between items-center mt-6 gap-4">
                     <div class="flex flex-wrap items-center gap-2 space-x-2">
                         ...
                         <button type="button" onclick="copyToClipboard()"
                            ...
                            <a href="<?php echo e(route('admin.customers.export', ['type' => 'excel', 'source' => 'today'] + request()->except(['from_date', 'to_date']))); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md hover:bg-gray-100 transition-colors duration-150">
                                Excel
                            </a>
                            <a href="<?php echo e(route('admin.customers.export', ['type' => 'csv', 'source' => 'today'] + request()->except(['from_date', 'to_date']))); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md hover:bg-gray-100 transition-colors duration-150">
                                CSV
                            </a>
                            <a href="<?php echo e(route('admin.customers.export', ['type' => 'pdf', 'source' => 'today'] + request()->except(['from_date', 'to_date']))); ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-blue-800 rounded-lg text-sm font-medium shadow-md hover:bg-gray-100 transition-colors duration-150">
                                PDF
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/customers/today.blade.php ENDPATH**/ ?>