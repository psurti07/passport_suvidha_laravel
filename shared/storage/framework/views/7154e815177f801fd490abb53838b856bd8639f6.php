<?php $__env->startSection('title', 'Final Details'); ?>
    ...
    <div class="mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100">
            <div class="p-4 sm:p-6 lg:p-8">
                <form id="filterForm" action="<?php echo e(route('admin.final-details.index')); ?>" method="GET">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 relative">
                                <thead class="bg-blue-50">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('customer_id', 'Customer'); ?>

                                        </th>
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('upload_date', 'Upload Date'); ?>

                                        </th>
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('uploaded_by', 'Uploaded By'); ?>

                                        </th>
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('is_approved', 'Status'); ?>

                                        </th>
                                        <th scope="col"
                                            class="sticky top-0 bg-blue-50 px-4 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                                            <?php echo sortLink('approved_date', 'Approved Date'); ?>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__empty_1 = true; $__currentLoopData = $finalDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $finalDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo e($finalDetail->upload_date ? $finalDetail->upload_date->format('d M Y, h:i A') : 'N/A'); ?>

                                            </td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo e($finalDetail->uploader->name ?? 'N/A'); ?>
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo e($finalDetail->approved_date ? $finalDetail->approved_date->format('d M Y, h:i A') : 'N/A'); ?>
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-blue-600">
                                                <a href="<?php echo e(Storage::url($finalDetail->file_path)); ?>" target="_blank"
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm">
                                                <div class="flex items-center space-x-3">
                                                    <a href="<?php echo e(route('admin.final-details.show', $finalDetail)); ?>"
                                                    ...
                                                    <a href="<?php echo e(route('admin.final-details.edit', $finalDetail)); ?>"
                                                    ...
                                                    <?php if(!$finalDetail->is_approved): ?>
                                                        <form action="<?php echo e(route('admin.final-details.approve', $finalDetail)); ?>"
                                                    ...
                                                    <?php else: ?>
                                                        <form action="<?php echo e(route('admin.final-details.unapprove', $finalDetail)); ?>"
                                                            method="POST" class="inline">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('PATCH'); ?>
                                                            <button type="submit"
                                        ...
                                        <tr>
                                            <td colspan="9" class="px-6 py-10 text-center">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <?php if(request('search') || request('approval_status')): ?>
                ...
                <div class="mt-6 px-4 sm:px-0 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-4">
                        <?php if($finalDetails->total() > 0): ?>
                            <p class="text-sm text-gray-500">
                                Showing
                                <span class="font-medium"><?php echo e($finalDetails->firstItem()); ?></span>
                                to
                                <span class="font-medium"><?php echo e($finalDetails->lastItem()); ?></span>
                                of
                                <span class="font-medium"><?php echo e($finalDetails->total()); ?></span>
                                results
                            </p>
                        <?php endif; ?>
                    </div>
                    <div>
                        <?php echo e($finalDetails->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel-app/releases/11/resources/views/admin/final-details/index.blade.php ENDPATH**/ ?>